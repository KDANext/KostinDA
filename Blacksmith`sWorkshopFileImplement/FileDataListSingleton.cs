...
namespace Blacksmith_sWorkshopFileImplement
{
    public class FileDataListSingleton
    {
        ...
        {
            SaveBillets(); SaveOrders(); SaveProducts(); SaveProductBillets();
        }
            ...
            if (Billets != null)
            {
                ...
                { 
                    xElement.Add(
                        ...
                        new XElement("BilletName", 
                        billet.BilletName))); }

                XDocument xDocument = new XDocument(xElement); xDocument.Save(BilletFileName);
            }
        }
        ...
        private void SaveProducts()
        {
            if (Products != null)
            {
                ...
                XDocument xDocument = new XDocument(xElement); xDocument.Save(ProductFileName);
            }
        }
        ...
        private void SaveProductBillets()
        {
            if (ProductBillets != null)
            {
                ...
                XDocument xDocument = new XDocument(xElement); xDocument.Save(ProductBilletFileName);
            }
        }
    }
}
